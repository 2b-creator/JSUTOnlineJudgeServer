# Generated by Django 5.1.3 on 2025-08-16 11:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('all_register_before_start', models.DurationField(default=datetime.timedelta(seconds=60))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('solved_contest', models.ManyToManyField(related_name='solved_contest', to='judge.competitionproblem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contest', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='judge.competition')),
                ('problem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='judge.competitionproblem')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
