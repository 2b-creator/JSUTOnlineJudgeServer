# Generated by Django 5.1.3 on 2025-08-10 08:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registered', models.ManyToManyField(related_name='registered_contest', to=settings.AUTH_USER_MODEL)),
                ...
                ('submissions', models.ManyToManyField(related_name='submissions', to='judge.submission')),
            ],
        ),
        migrations.CreateModel(
